          ...
          <div className="lg:flex lg:items-center lg:justify-between">
            <div className="lg:w-1/2">
              <h1 className="text-4xl font-bold text-gray-900 sm:text-5xl">
                Transformando{" "}
                <span className="text-[#c39eb0]"> vidas</span>{" "}
               através da {" "}
               <span className="text-[#c39eb0]"> comunicação</span>.
              </h1>
              <p className="mt-3 text-lg text-gray-600">
                Ajudo seu filho(a) a desenvolver a fala e a linguagem através do brincar.
              </p>
              <div className="mt-8">
                <BotaoAgendamento />
              </div>
